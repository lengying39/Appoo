...
public partial class SettingsPage : ContentPage
{
    ...
    {
        await DisplayAlert("切换识别服务", "请在 MauiProgram.cs 中将 UnrecognizableImageService 替换为 RecognizableImageService，并配置 Azure 密钥。", "确定");
    }
    private async void OnClearCache(object sender, EventArgs e)
    {
        await DisplayAlert("缓存", "缓存已清除（模拟）。", "OK");
    }
